...
/***/ "../src/component/mask.component.ts":
/*!******************************************!*\
  !*** ../src/component/mask.component.ts ***!
  \******************************************/
/*! exports provided: CapivaraMask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CapivaraMask", function() { return CapivaraMask; });
...
var CapivaraMask = /** @class */ (function () {
    function CapivaraMask($scope, $element) {
        this.$scope = $scope;
        this.$element = $element;
    }
    CapivaraMask.prototype.$onInit = function () {
        if (!this.$constants.mask) {
            throw new Error('mask é um parâmetro obrigatório.');
        }
        this.applyMask();
    };
    CapivaraMask.prototype.$destroy = function () {
        this.mask.off('accept');
        this.mask.off('complete');
        this.mask.destroy();
    };
    CapivaraMask.prototype.applyMask = function () {
        var _this = this;
        var maskOptions = {
            mask: this.$constants.mask,
            lazy: !!this.$constants.placeholder,
        };
        this.mask = new imask__WEBPACK_IMPORTED_MODULE_0___default.a(this.$element.querySelector('input'), maskOptions);
        this.mask.on('accept', function () { return _this.$bindings.cpModel = null; });
        this.mask.on('complete', function () {
            _this.$bindings.cpModel = _this.mask.unmaskedValue;
        });
...
/***/ "../src/component/mask.template.html":
/*!*******************************************!*\
  !*** ../src/component/mask.template.html ***!
  \*******************************************/
/*! no static exports found */
...
module.exports = "<div class=\"cp-mask-wrapper\">\n  <input type=\"text\">\n</div>\n";
...
/* harmony import */ var _component_mask_template_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./component/mask.template.html */ "../src/component/mask.template.html");
/* harmony import */ var _component_mask_template_html__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_component_mask_template_html__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _component_mask_style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/mask.style.scss */ "../src/component/mask.style.scss");
/* harmony import */ var _component_mask_style_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_component_mask_style_scss__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _component_mask_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/mask.component */ "../src/component/mask.component.ts");
/*
...
var Component = {
     ...
     */
    template: _component_mask_template_html__WEBPACK_IMPORTED_MODULE_1___default.a,
    /**
     * @name style
     * @description Import component style
     */
    style: _component_mask_style_scss__WEBPACK_IMPORTED_MODULE_2___default.a,
    /**
     * @name constants
     ...
     */
    controller: _component_mask_component__WEBPACK_IMPORTED_MODULE_3__["CapivaraMask"]
};
/* harmony default export */ __webpack_exports__["default"] = (capivarajs__WEBPACK_IMPORTED_MODULE_0___default.a.component('cp-mask', Component));


/***/ })

/******/ });
//# sourceMappingURL=cp-mask.js.map